...
void FSpudModule::StartupModule()
{
	...
	UE_LOG(LogSpudModule, Log, TEXT("Steve's Persistence for Unreal Engine Module Started"))
}
...
void FSpudModule::ShutdownModule()
{
	...
	UE_LOG(LogSpudModule, Log, TEXT("Steve's Persistence for Unreal Engine Module Stopped"))
}
